...
function menu() {
  const menuHorizontal = document.getElementById('horizontal'); // Pegando o elemento corretamente

  if (window.innerWidth >= 900) {
    if (window.scrollY <= 593) {
      menuHorizontal.style.display = "none"; // Corrigido para string
    } else {
      menuHorizontal.style.display = "flex"; // Corrigido para string
    }
  } else {
